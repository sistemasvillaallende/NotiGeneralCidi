<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MasivoDeudaIyC.aspx.cs" Inherits="NotificacionesCIDI.Secure.MasivoDeudaIyC" %>
                        ...
                        <div class="box-body no-padding">
                            <div class="nav-tabs-custom" style="padding-top: 30px;">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item"><a class="nav-link active" href="#tab_3" data-toggle="tab" aria-expanded="false">INDUSTRIA Y COMERCIO</a></li>
                                    <%--<li class="pull-right">
