<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" MasterPageFile="~/Master/MasterPage.master"
                            ...
                            <div class="nav-tabs-custom" style="padding-top: 30px;">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item"><a class="nav-link active" href="#tab_3" data-toggle="tab"
                                            aria-expanded="false">INMUEBLES</a></li>
                                    <%--<li class="pull-right">
                                            ...
                                            <div class="col-md-12">
                                                <div id="divFiltros" runat="server">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <label>Fecha</label>
                                                            <asp:DropDownList ID="ddlFecha" CssClass="form-control"
                                                                runat="server">
                                                                ...
                                                                <asp:ListItem Text="Deuda entre" Value="2">Deuda
                                                                    entre</asp:ListItem>
                                                            </asp:DropDownList>
                                                            <br />
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <asp:TextBox ID="txtDesde" Enabled="false"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <asp:TextBox ID="txtHasta" Enabled="false"
                                                                        TextMode="Date" CssClass="form-control"
                                                                        runat="server"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <asp:DropDownList ID="DDLCatDeuda" CssClass="form-control"
                                                                runat="server">
                                                            ...
                                                            <br />
                                                            <asp:ListBox ID="lstCatDeuda" Height="90"
                                                        ...
                                                        <div class="col-md-1">
                                                            <label>Zona</label>
                                                            <asp:ListBox ID="lstZonas" Height="143"
                                                                CssClass="form-control" runat="server"
                                                                SelectionMode="Multiple"></asp:ListBox>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <asp:ListBox ID="lstTipoDeuda"
                                                                        SelectionMode="Multiple" Height="143"
                                                                        CssClass="form-control list-group"
                                                                        runat="server">
                                                                        <asp:ListItem>Deuda Judicial</asp:ListItem>
                                                                        <asp:ListItem>Deuda Pre-Judicial
                                                                        </asp:ListItem>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <asp:DropDownList ID="ddlFiltroDeuda"
                                                                        CssClass="form-control" runat="server">
                                                                        <asp:ListItem Text="Sin filtro" Value="3">
                                                                        </asp:ListItem>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <asp:TextBox ID="txtMontoDesde" MIN="0"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <asp:TextBox ID="txtMontoHasta" MIN="0"
                                                                                Enabled="false" TextMode="Number"
                                                                                CssClass="form-control" runat="server">
                                                                            </asp:TextBox>
                                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12" style="text-align: right;">
                                                            ...
                                                            <button type="button" class="btn btn-outline"
                                                                ...
                                                                <span class="fa fa-filter"></span>&nbsp;Aplicar
                                                                Filtros
                                                            </button>
                                                ...
                                                <div id="divResultados" runat="server" visible="false"
                                                    ...
                                                    <div class="row">
                                                        <div class="12" style="text-align: right">
                                                            ...
                                                            <button type="button" id="btnNoti" class="btn btn-outline"
                                                                ...
                                                                <span class="fa fa-sheet-plastic"></span>&nbsp;
                                                                Generar notificación CIDI
                                                            </button>
                                                            ...
                                                            <asp:GridView ID="gvDeuda" CssClass="table" runat="server"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="zona"
                                                                        ControlStyle-Width="10%" HeaderText="Zona">
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="deudaJudicial"
                                                                    ...
                                                                    <asp:BoundField DataField="deudaAdministrativa"
                                                                        ControlStyle-Width="10%"
                                                                        DataFormatString="{0:c}"
                                                                        HeaderText="Administrativa">
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="deudaNormal"
                                                                        ControlStyle-Width="10%"
                                                    ...
                                                    <div class="row" style="padding-top: 20px;">
                                                        <div class="col-md-2 form-group">
                                                            ...
                                                            <asp:TextBox ID="txtRegistros" CssClass="form-control"
                                                                runat="server"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-2 form-group">
                                                            <label>Deuda Judicial</label>
                                                            <asp:TextBox ID="txtTotJudicial" CssClass="form-control"
                                                                runat="server"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-2 form-group">
                                                            <label>Deuda Pre-Judicial</label>
                                                            <asp:TextBox ID="txtPreJudicial" CssClass="form-control"
                                                                runat="server"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-2 form-group">
                                                            <label>Deuda Administrativa</label>
                                                            <asp:TextBox ID="txtAdministrativa" CssClass="form-control"
                                                                runat="server">
                                                            </asp:TextBox>
                                                        </div>
                                                        <div class="col-md-2 form-group">
                                                            <label>Deuda Normal</label>
                                                            <asp:TextBox ID="txtNormal" CssClass="form-control"
                                                                runat="server"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-2 form-group">
                                                            <label>Deuda Total</label>
                                                            <asp:TextBox ID="txtTotal" CssClass="form-control"
                                                                runat="server"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
